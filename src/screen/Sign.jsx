    ...
    return (
            <View style={{flex:1,backgroundColor:'white'}}>
                ...
                <View style={{paddingLeft:50}}>
                    ...
                    <Text style={{color:'#8b8d96', fontSize:20}}>Create a new account</Text>
                </View>
    
                <View style={{ paddingLeft:50, paddingRight:80}}>
                   <TextInput style={{borderBottomWidth:1, fontSize:20, marginTop: 30}} placeholder={'Nome'}>
                    </TextInput>
               ...
               <View style={{alignItems:'center'}}>
                    <Text style={{color:'#8b8d96', fontSize: 15}}>Social Media SignUp</Text>
               ...
               <View style={{marginHorizontal:50, flexDirection:'row', marginTop: 12}}>
                        <Text style={{color:'#8b8d96', fontSize:14}}>Already have an account?</Text>
